...
r3col1, r3col2, r3col3 = st.columns([2, 2, 2])# Create two columns, one smaller (1) and one larger (2)
...
if selected_page == nav_pages[0]:
    ...
    with r2col2:
        ...
        st.write("**Servius Tullius** aedificit **Muri Serviani**")
        st.write("**Sextus Tullius** habet **primum censum**")
